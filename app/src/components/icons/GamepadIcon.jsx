...
export default function GamepadIcon({ className }) {
  return (
    ...
    >
      ...
      <circle cx="292" cy="224" r="10" />
      <circle cx="336" cy="268" r="10" />
      <circle cx="336" cy="180" r="10" />
      <circle cx="380" cy="224" r="10" />
      <line x1="160" y1="176" x2="160" y2="272" strokeLinecap="round" strokeLinejoin="round" />
      <line x1="208" y1="224" x2="112" y2="224" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
